...
keys = [
    # Key Binding
    Key([mod], "d", lazy.spawn("rofi -show drun -show-icons"), desc="Run Rofi"),
    ...
    Screen(
        bottom=bar.Bar(
            [
                ...
                #widget.DF(),
                widget.PulseVolume(font="JetBrainsMono Nerd Font",
                        fontsize = 15,
                        fmt="󰕾 {}",
                        foreground=colors[9],
                        background=colors[1],
                ...
                #widget.Spacer(
                        ...
                        #),
                widget.Battery(font="JetBrainsMono Nerd Font",
                        fontsize = 15,
                ...
                #widget.Memory(font="JetBrainsMono Nerd Font",
                        #fontsize = 15,
                        #padding=5,
                        ...
                        #**arrow_powerlineRight,
                        #),
                #widget.CPU(font="JetBrainsMono Nerd Font",
                        #fontsize = 15,
                        #padding=5,
                ...
                #widget.Bluetooth(),
                #widget.BatteryIcon(),
                widget.Clock(font="JetBrainsMono Nerd Font",
                        fontsize = 15,
                        foreground = colors[9],
                        background = colors[1],
                        format='󰥔 %H:%M:%S',
